    ...
    public function datatables()
    {
        ...
        return Datatables::of($datas)
            ...
            ->addColumn('action', function (User $data) {
                ...
                $vendor = '';
                /* $manage_deposit = '<a href="javascript:;" data-toggle="modal" data-target="#modal1" class="deposit" data-href="' . route('admin-user-deposit', $data->id) . '" >
                ...
                return '<div class="godropdown"><button class="go-dropdown-toggle">' . __('Actions') . '<i class="fas fa-chevron-down"></i></button><div class="action-list">'.$manage_deposit.'<a data-href="' . route('admin-user-edit', $data->id) . '" class="edit" data-toggle="modal" data-target="#modal1">
