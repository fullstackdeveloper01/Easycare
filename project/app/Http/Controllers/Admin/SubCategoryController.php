...
class SubCategoryController extends AdminBaseController
{
    ...
    public function datatables()
    {
         ...
         return Datatables::of($datas)
                            ...
                            ->addColumn('icon', function(Subcategory $data) {
                                if(!empty($data->icon)){
                                    return '<img height="65px" src="/assets/images/sub-categories/'.$data->icon.'">';
                                }
                                else{
    ...
    public function store(Request $request)
    {
        ...
        if ($file = $request->file('icon'))
        {
            ...
            $file->move('assets/images/sub-categories',$name);
            $input['icon'] = $name;
        }
    ...
    public function update(Request $request, $id)
    {
        ...
        if ($file = $request->file('icon'))
        {
            ...
            if($data->icon != null)
            {
                if (file_exists(public_path().'/assets/images/sub-categories/'.$data->icon)) {
                    unlink(public_path().'/assets/images/sub-categories/'.$data->icon);
                }
            }
            $input['icon'] = $name;
        }
