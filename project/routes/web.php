...
Route::get('/manage/city/{country}', 'Admin\CityController@manageState')->name('admin-city-index');
...
/////////////////////////////// ////////////////////////////////////////////
  ...
  //------------ ADMIN MANAGE DUKAN SECTION ------------
   Route::group(['middleware'=>'permissions:dukans'],function(){
    Route::get('/dukan/datatables', 'Admin\DukanController@datatables')->name('admin-dukan-datatables'); //JSON REQUEST
    Route::get('/dukan', 'Admin\DukanController@index')->name('admin-dukan-index');
    Route::get('/dukan/create', 'Admin\DukanController@create')->name('admin-dukan-create');
    Route::post('/dukan/create', 'Admin\DukanController@store')->name('admin-dukan-store');
    Route::get('/dukan/edit/{id}', 'Admin\DukanController@edit')->name('admin-dukan-edit');
    Route::post('/dukan/edit/{id}', 'Admin\DukanController@update')->name('admin-dukan-update');
    Route::delete('/dukan/delete/{id}', 'Admin\DukanController@destroy')->name('admin-dukan-delete');
    Route::get('/dukan/status/{id1}/{id2}', 'Admin\DukanController@status')->name('admin-dukan-status');
  });

  //------------ ADMIN MANAGE CATEGORY SECTION ------------
   Route::group(['middleware'=>'permissions:crops'],function(){

    Route::get('/crop/datatables', 'Admin\CropController@datatables')->name('admin-crop-datatables'); //JSON REQUEST
    Route::get('/crop', 'Admin\CropController@index')->name('admin-crop-index');
    Route::get('/crop/create', 'Admin\CropController@create')->name('admin-crop-create');
    Route::post('/crop/create', 'Admin\CropController@store')->name('admin-crop-store');
    Route::get('/crop/edit/{id}', 'Admin\CropController@edit')->name('admin-crop-edit');
    Route::post('/crop/edit/{id}', 'Admin\CropController@update')->name('admin-crop-update');
    Route::delete('/crop/delete/{id}', 'Admin\CropController@destroy')->name('admin-crop-delete');
    Route::get('/crop/status/{id1}/{id2}', 'Admin\CropController@status')->name('admin-crop-status');
  });
  ...
  Route::get('/general-settings/app-version', 'Admin\GeneralSettingController@appVersion')->name('admin-gs-app-version');
  Route::get('/general-settings/intro-screen', 'Admin\GeneralSettingController@intro_screen')->name('admin-gs-intro');
  Route::get('/general-settings/splash_screen', 'Admin\GeneralSettingController@splash_screen')->name('admin-gs-ss');
