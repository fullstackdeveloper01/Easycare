										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-store') }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="district" placeholder="{{ __("District") }}" required="" value="">
													</div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">{{ __("Tehsil") }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="tehsil" placeholder="{{ __("Tehsil") }}" required="" value="">
													</div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-4">
														<div class="left-area">
															<h4 class="heading">{{ __("Village") }} *</h4>
														</div>
													</div>
													<div class="col-lg-7">
														<input type="text" class="input-field" name="village" placeholder="{{ __("Village") }}" required="" value="">
													</div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-4">
												...
												<div class="row" style="display: none;">
													...
													<div class="col-lg-7">
                                                        ...
                                                        <select class="input-field" name="country" required>
                                                            ...
                                                            <option value="India" selected>{{ __('India') }}</option>
                                                            {{--
												...
												<div class="row">
													...
													<div class="col-lg-4">
														...
														<div class="left-area">
																...
																<h4 class="heading">{{ __("Pincode") }} </h4>
													...
													<div class="col-lg-7">
														...
														<input type="text" class="input-field" name="zip" placeholder="{{ __("Pincode") }}" value="">
