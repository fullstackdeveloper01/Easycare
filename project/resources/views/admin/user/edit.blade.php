										...
										<div class="product-description">
											...
											<form id="geniusformdata" action="{{ route('admin-user-edit',$data->id) }}" method="POST" enctype="multipart/form-data">
												...
												<div class="row">
													...
													<div class="col-lg-7">
													  <input type="text" class="input-field" name="district" placeholder="{{ __('District') }}" required="" value="{{ $data->district }}">
													</div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="tehsil" placeholder="{{ __("Tehsil") }}" required="" value="{{ $data->tehsil }}">
													</div>
                                                </div>
                                                <div class="row">
													<div class="col-lg-4">
													...
													<div class="col-lg-7">
														<input type="text" class="input-field" name="village" placeholder="{{ __("Village") }}" required="" value="{{ $data->village }}">
													</div>
                                                </div>
