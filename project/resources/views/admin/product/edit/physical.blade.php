												...
												<div class="col-lg-12">
													...
													<div class="product-description">
														...
														<div class="row">
															...
															<div class="col-lg-12">
																<div class="text-editor">
																	<textarea class="nic-edit-p" name="key_points">{{$data->key_points}}</textarea>
																</div>
															</div>
														</div>
														<div class="row">
															...
															<div class="col-lg-12">
																<div class="text-editor">
																	<textarea class="nic-edit-p" name="material">{{$data->material}}</textarea>
																</div>
															</div>
														</div>
{{--
...
--}}
														<div class="row">
															<div class="col-lg-12">
																<div class="checkbox-wrapper">
																	<input type="checkbox" name="policy" value="1" {{ ($data->policy == "1")?"checked":""}} class="checkclickr">
																	<label for="allowProductReturnPolicy">{{ __('Product Buy/Return Policy') }}</label>
																</div>
															</div>
														</div>
														<div class="row">
													...
													<div class="product-description">
														...
														<div class="body-area">
															...
															<div class="row">
									                          <div class="col-lg-12">
									                            <div class="left-area">
									                                <h4 class="heading">{{ __("Dukan") }}</h4>
									                            </div>
									                          </div>
									                          <div class="col-lg-12">
									                              <select name="dukan_id[]" class="form-control dukan_id" multiple="multiple">
									                                <option value="" disabled>{{ __("Select Dukan") }}</option>
									                                  @foreach($dukans as $dukan)
									                                    <option value="{{ $dukan->id }}" {{ (in_array($dukan->id, $dukanArr))?'selected':'' }}>{{ $dukan->shop_name }}</option>
									                                  @endforeach
									                              </select>
									                          </div>
									                        </div>
															  ...
															  <input type="hidden" id="feature_photo" name="photo" value="{{ $data->photo }}" accept="image/*">
																...
																<div class="row" style="display: none;">
																	...
																	<div class="col-lg-12">
																		...
																		<input name="price" type="number" id="current_price" class="input-field" placeholder="e.g 20" step="0.1" min="0" value="{{round($data->price * $sign->value , 2)}}" required="">
														...
														<div class="row">
															...
															<div class="col-lg-12">
																<div class="packing-keyword-area">
																	<div class="heading-area">
																		<h4 class="title">{{ __('Packing') }} *</h4>
																	</div>			
																	<div class="packing-tag-top-filds" id="packing-section">
																		@if(!empty(@$packingmeasure))
																			@foreach(@$packingmeasure as $key => $data2)
																				@if($key == 0)
																					<div class="packing-area">
																						{{--<span class="remove packing-remove text-danger"><i class="fas fa-times"></i></span>--}}
																						<div class="row">
																							<div class="col-lg-12">
																								<select name="packing_measure[]" id="packing_measure" required>
																								    <option value="">{{ __('Select Unit') }}</option>
																								    <option value="Gram" {{ ($packingmeasure[$key] == "Gram")?"selected":"" }}>{{ __('Gram') }}</option>
																								    <option value="Kilogram" {{ ($packingmeasure[$key] == "Kilogram")?"selected":"" }}>{{ __('Kilogram') }}</option>
																								    <option value="Milliliter" {{ ($packingmeasure[$key] == "Milliliter")?"selected":"" }}>{{ __('Milliliter') }}</option>
																								    <option value="Litre" {{ ($packingmeasure[$key] == "Litre")?"selected":"" }}>{{ __('Litre') }}</option>
																								    <option value="Pound" {{ ($packingmeasure[$key] == "Pound")?"selected":"" }}>{{ __('Pound') }}</option>
																								    <option value="Pieces" {{ ($packingmeasure[$key] == "Pieces")?"selected":"" }}>{{ __('Pieces') }}</option>
																								</select>
																							</div>
																							<div class="col-lg-12 form-group">
																								<input type="text" name="packing_size[]" class="input-field" placeholder="{{ __('Enter size') }}" value="{{ $packingsize[$key] }}" required>
																							</div>
																							<div class="col-lg-12 form-group">
																								<input type="number" name="packing_price[]" id="packing_price" class="input-field" placeholder="{{ __('Enter price') }}" value="{{ $packingprice[$key] }}" step="0.1" required="" min="0" maxlength="7" onkeyup="setProductPrice()" required>
																							</div>
																						</div><hr>
																					</div>
																				@else
																					<div class="packing-area">
																						...
																						<div class="row">
																							...
																							<div class="col-lg-12 form-group">
																								<input type="text" name="packing_size[]" class="input-field" placeholder="{{ __('Enter size') }}" value="{{ $packingsize[$key] }}">
																							</div>
																							<div class="col-lg-12 form-group">
																								<input type="number" name="packing_price[]" class="input-field" placeholder="{{ __('Enter price') }}" value="{{ $packingprice[$key] }}" step="0.1" min="0">
																							</div>
																						</div><hr>
																					</div>
																				@endif
																			...
																			<div class="row">
																				<div class="col-lg-12">
																					<select name="packing_measure[]">
																					    ...
																					    <option value="Milliliter">{{ __('Milliliter') }}</option>
																					    <option value="Litre">{{ __('Litre') }}</option>
																					    <option value="Pound">{{ __('Pound') }}</option>
																					    <option value="Pieces">{{ __('Pieces') }}</option>
																					</select>
																				</div>
																				<div class="col-lg-12 form-group">
																					<input type="text" name="packing_size[]" class="input-field" placeholder="{{ __('Enter size') }}">
																				</div>
																				<div class="col-lg-12 form-group">
																					<input type="text" name="packing_price[]" class="input-field" placeholder="{{ __('Enter price') }}" step="0.1" min="0">
																				</div>
																			</div><hr>
																		</div>
																	</div>
																	<a href="javascript:;" id="packing-btn" class="add-fild-btn"><i class="icofont-plus"></i> {{ __('Add More Field') }}</a>
																</div>
															</div>
														</div>
														<!--// End-->
