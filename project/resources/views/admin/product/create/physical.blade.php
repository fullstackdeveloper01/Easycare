							...
							<div class="mr-breadcrumb">
								...
								<div class="row">
									...
									<div class="col-lg-12">
										...
										<h4 class="heading">{{ __('Product') }} <a class="add-btn" href="{{ route('admin-prod-index') }}"><i class="fas fa-arrow-left"></i> {{ __('Back') }}</a></h4>
										...
										<ul class="links">
											...
											<li>
												...
												<a href="javascript:void()">{{ __('Add Product') }}</a>
													...
													<div class="product-description">
														...
														<div class="body-area">
															...
															<div class="row">
																...
																<div class="col-lg-12">
																	<div class="text-editor">
																		<textarea class="nic-edit-p" name="key_points"></textarea>
																	</div>
																</div>
															</div>
															<div class="row">
																...
																<div class="col-lg-12">
																	<div class="text-editor">
																		<textarea class="nic-edit-p" name="material"></textarea>
																	</div>
																</div>
															</div>
{{--
															...
															<div class="row">
																<div class="col-lg-12">
																	<div class="checkbox-wrapper">
																		<input type="checkbox" name="policy" value="1" class="checkclickr">
													...
													<div class="product-description">
														...
														<div class="body-area">
															<div class="row">
									                          ...
									                          <div class="col-lg-12">
									                              <select name="dukan_id[]" class="form-control dukan_id" multiple>
									                                <option value="" disabled>{{ __("Select Dukan") }}</option>
									                                  @foreach($dukans as $dukan)
									                                    <option value="{{ $dukan->id }}">{{ $dukan->shop_name }}</option>
									                                  @endforeach
									                              </select>
									                          </div>
									                        </div>
															...
															<div class="row" style="display: none;">
																...
																<div class="col-lg-12">
																	...
																	<input name="price" id="current_price" type="number" class="input-field" placeholder="{{ __('e.g 20') }}" step="0.1" required="" min="0">
																	...
																	<div class="packing-keyword-area">
																		...
																		<div class="packing-tag-top-filds" id="packing-section">
																			<div class="packing-area">
																				...
																				<div class="row">
																					<div class="col-lg-12">
																						<select id="packing_measure" name="packing_measure[]" required>
																					...
																					<div class="col-lg-12 form-group">
																						<input type="text" name="packing_size[]" class="input-field" placeholder="{{ __('Enter size') }}" required>
																					</div>
																					<div class="col-lg-12 form-group">
																						<input type="number" name="packing_price[]" id="packing_price" class="input-field" step="0.1" required="" min="0" maxlength="7" onkeyup="setProductPrice()" placeholder="{{ __('Enter price') }}" required>
																					</div>
																				</div><hr>
																			</div>
																		</div>
