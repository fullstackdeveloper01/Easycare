                  ...
                  <div class="col-lg-12">
                    ...
                    <div class="product-description">
                      ...
                      <div class="body-area">
                        ...
                        <form id="geniusformdata" action="{{route('admin-crop-create')}}" method="POST" enctype="multipart/form-data">
                          ...
                          <div class="row">
                            ...
                            <div class="col-lg-7">
                              ...
                              <button class="addProductSubmit-btn" type="submit">{{ __('Create Crop') }}</button>
