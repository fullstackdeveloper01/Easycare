    <li>
        <a href="{{ route('admin-user-index') }}">
            <i class="icofont-users"></i>{{ __('Customers') }}
        </a>
    </li>
    <li>
            <a href="#menu5" class="accordion-toggle wave-effect" data-toggle="collapse" aria-expanded="false"><i class="fas fa-sitemap"></i>{{ __('Masters') }}</a>
            ...
            @endif" id="menu5" data-parent="#accordion" >
                    ...
                    <li>
                        <a href="{{ route('admin-crop-index') }}"><span>{{ __('Crops') }}</span></a>
                    </li>
                    <li>
                        <a href="{{ route('admin-sl-index') }}"><span>{{ __('Sliders') }}</span></a>
                    </li>
                    <li>
                        <a href="{{ route('admin-page-index') }}"><span>{{ __('System Pages') }}</span></a>
                    </li>
                    <li>
                        <a href="{{route('admin-lang-index')}}"><span>{{ __('Website Language') }}</span></a>
                    </li>
                    <li>
    ...
    <li>
        <a href="{{ route('admin-dukan-index') }}">
            <i class="icofont-shopify"></i>{{ __('Dukan') }}
        </a>
    </li>
    <li>
    ...
    <li>
        <a href="javascript:void();">
            <i class="icofont-users"></i>{{ __('MLM') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-film"></i>{{ __('Reels') }}
        </a>
    </li>    
    <li>
        <a href="javascript:void();">
            <i class="icofont-bullhorn"></i>{{ __('Advertisement') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-gift-box"></i>{{ __('Schemes') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-oscommerce"></i>{{ __('Community') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-address-book"></i>{{ __('Krishi Gyan') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-money"></i>{{ __('Refer & Earn') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-table"></i>{{ __('Offers') }}
        </a>
    </li>
    <li>
        <a href="javascript:void();">
            <i class="icofont-bell-alt"></i>{{ __('Feedback') }}
        </a>
    </li>
{{--
    <li>
...
--}}
    ...
    <li>
        ...
        <ul class="collapse list-unstyled" id="general" data-parent="#accordion">
            ...
            <li>
                <a href="{{ route('admin-gs-ss') }}"><span>{{ __('Splash Screen') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-gs-intro') }}"><span>{{ __('Intro Screen') }}</span></a>
            </li>
            <li>
                <a href="{{ route('admin-gs-app-version') }}"><span>{{ __('App Version') }}</span></a>
            </li>
            {{--
            <li>
