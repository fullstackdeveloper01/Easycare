                                ...
                                '<span class="remove packing-remove text-danger"><i class="fas fa-times"></i></span>'+
                                    '<div  class="row">'+
                                        ...
                                        '<div class="col-lg-12 form-group">'+
                                            '<input type="text" name="packing_size[]" class="input-field" placeholder="Enter size">'+
                                        '</div>'+
                                        '<div class="col-lg-12 form-group">'+
                                            '<input type="number" name="packing_price[]" class="input-field" step="0.1" min="0" placeholder="Enter price">'+
                                        '</div>'+
                                    '</div><hr>'+
                            '</div>'
                            +'');
...
$(document).on('click','.packing-remove', function(){    
        $(this.parentNode).remove();
        if (isEmpty($('#packing-section'))) {    
        $("#packing-section").append(''+
                                '<div class="packing-area">'+
                                    '<span class="remove packing-remove"><i class="fas fa-times"></i></span>'+
                                        '<div  class="row">'+
                                            '<div class="col-lg-12">'+
                                                '<select name="packing_measure[]" id="packing_measure">'+
                                                    '<option value="">{{ __("Select Unit") }}</option>'+
    ...
    function setProductPrice(){
        ...
        $('#current_price').val(packing_price);
    }
